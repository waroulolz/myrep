...
The tool is written in \textbf{$R$} and it's web client-server part is mostly handled by a library called \textbf{Shiny}.
...
As for the rest, I use \textbf{Plotly} for the nice visual appearance plots and their nice interaction with the user. I use \textbf{e1071} for the SVM's models and \textbf{gbcode} for the K-NNs models. Finally, the \textbf{quantmod} library is used to download the data sets from the Internet.
